<template>
   <br>
    ...
    <div class="mt-20 text-center">
      <span class="font-bold text-4xl"> 𝘿𝙚𝙩𝙖𝙞𝙡 𝙋𝙧𝙤𝙙𝙪𝙘𝙩 </span>
      <p class="mb-4"></p>
    </div>
                      ...
                      <div
                          ...
                          <div v-if="token">
                              <button @click="addToCart(product.id)" type="button"
                                  class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-pink-700 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-pink-700">

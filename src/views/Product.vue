<template>
  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md text-center">
      ...
      <p class="mt-4 text-base text-gray-700"> Choose a scent that lasts all day. </p>
    </div>

    <div class="mt-10 grid grid-cols-2 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/arabianmusk.jpeg" alt="" />
        </div>
        ...
        <div class="mt-4 flex items-start justify-between">
          ...
          <div class="text-right">
            <del class="mt-px text-xs font-semibold text-gray-600 sm:text-sm"> $99.00 </del>
            <p class="text-xs font-normal sm:text-sm md:text-base"> $85.00 </p>
          </div>
        </div>
      </article>
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/musk2.jpeg" alt="" />
        </div>
        <div class="mt-4 flex items-start justify-between">
          <div class="">
            <h3 class="text-xs font-semibold sm:text-sm md:text-base">
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/musk3.jpeg" alt="" />
        </div>
        <div class="mt-4 flex items-start justify-between">
          <div class="">
            <h3 class="text-xs font-semibold sm:text-sm md:text-base">
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/musk4.jpeg" alt="" />
        </div>
        <div class="mt-4 flex items-start justify-between">
          <div class="">
            <h3 class="text-xs font-semibold sm:text-sm md:text-base">

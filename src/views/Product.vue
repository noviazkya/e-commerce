<template>
  ...
  <div v-for="product in getProducts.slice(0, 12)" :key="product.slug" class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
    ...
    <a href="#">
    <img class="h-60 mt-10 rounded-t-lg object-cover" src="https://i.pinimg.com/564x/1e/d9/a2/1ed9a213e183db2fb6773f8c36cc529d.jpg" width="500" alt="product image" />
  </a>
<!-- </router-link> -->
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <div class="flex items-center justify-between flex-wrap">
      ...
      <router-link :to="{ name: 'SingleProduct', params: { slug: product.slug } }" class="group pt-5">
